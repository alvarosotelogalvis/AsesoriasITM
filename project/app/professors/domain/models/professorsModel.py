...
class professorModel(Base):
    ...
    identification_card = Column(Integer, nullable=False, index=True)
    ...
    institutional_email = Column(String(100), nullable=False)
    personal_email = Column(String(100), nullable=False)
    email_with_domain = Column(String(100), nullable=False)
    faculty_location = Column(String(150))
